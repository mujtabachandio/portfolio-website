...
const Contact = () => {
  return (
    <>
    <div className="max-w-7xl max-lg:max-w-3xl mx-auto bg-[#141414] my-6 font-[sans-serif]">
            <div className="text-center px-6">
                <h2 className=" text-3xl font-extrabold">Contact Us</h2>
                <p className="text-sm  mt-4">Have some big idea or brand to develop and need help?</p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul className="flex flex-wrap gap-4 mt-16">
                        <li className="bg-[#FFA300] duration-300 hover:bg-gray-900 h-12 w-12 rounded-full flex items-center justify-center shrink-0">
  ...
  <path d="M32 6.076a13.1 13.1 0 0 1-3.77 1.032 6.563 6.563 0 0 0 2.887-3.622 13.047 13.047 0 0 1-4.167 1.588 6.565 6.565 0 0 0-11.18 5.982 18.627 18.627 0 0 1-13.537-6.85 6.558 6.558 0 0 0 2.033 8.772 6.514 6.514 0 0 1-2.97-.823v.082a6.566 6.566 0 0 0 5.26 6.43 6.591 6.591 0 0 1-2.96.112 6.563 6.563 0 0 0 6.13 4.56A13.14 13.14 0 0 1 0 26.087a18.558 18.558 0 0 0 10.032 2.94c12.037 0 18.627-10.037 18.627-18.627 0-.284-.007-.567-.02-.85A13.177 13.177 0 0 0 32 6.076z"/>
</svg>
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                        <div className="grid sm:grid-cols-2 gap-8">
                            <div className="relative flex items-center">
                                <input type="text" placeholder="First Name"
                                    className="px-2 py-3 bg-[#171717] w-full text-sm  border-b border-gray-300 focus:border-blue-500 outline-none" />
                            ...
                            <div className="relative flex items-center">
                                <input type="number" placeholder="Phone No."
                                    className="px-2 py-3 bg-[#171717] text-black w-full text-sm  border-b border-gray-300 focus:border-blue-500 outline-none" />
                            ...
                            <div className="relative flex items-center sm:col-span-2">
                                <textarea placeholder="Write Message"
                                    className="px-2 pt-3 bg-[#171717] text-black w-full text-sm  border-b border-gray-300 focus:border-blue-500 outline-none"></textarea>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                                    viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                    ...
                                    <g clip-path="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
                                        <path fill="none" stroke-miterlimit="10" stroke-width="40"
                                            ...
                                            data-original="#000000"></path>
                                        <path
                                            d="M472 274.9V107.999c0-11.027-8.9720-20-20H60c-11.028 0-20 8.973-20 20V274.9L0 304.652V107.999c0-33.084 26.916-60 60-60h392c33.084 0 60 26.916 60 60v196.653Z"
                                            data-original="#000000"></path>
                                    </g>
                                </svg>
                            </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm  ml-4">General Inquiry</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm  ml-4">Technical Support</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm  ml-4">Website Feedback</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-[#FFA300] duration-500 hover:bg-black">
